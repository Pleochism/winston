...
File.prototype.getCurrentRotation = function(dateArg) {
  ...
  if(this.rotation == "day")
    return date.getFullYear().toString() + (date.getMonth() < 9 ? "0" + (date.getMonth()) : (date.getMonth())) + (date.getDate() < 10 ? "0" + date.getDate() : date.getDate());
  else if(this.rotation == "month")
    return date.getFullYear().toString() + (date.getMonth() < 9 ? "0" + (date.getMonth()) : (date.getMonth()));
...
File.prototype.archiveOldFiles = function() {
  ...
  var cutoff = new Date(this.currentRotation.substr(0, 4), this.currentRotation.substr(4, 2), this.currentRotation.substr(6, 2));
...
File.prototype.query = function (options, callback) {
  ...
  function previousFile() {
    ...
    if(self.rotation) {
      var cutoff = new Date(currentRotation.substr(0, 4), currentRotation.substr(4, 2), currentRotation.substr(6, 2));
      // Jump back 1 day
